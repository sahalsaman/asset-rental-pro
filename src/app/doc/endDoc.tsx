  ...
  return (
    <div className=" overflow-hidden">
      <div className="flex flex-col  min-h-[500px]">
        ...
        <div className="w-full  bg-green-700 text-white flex flex-col justify-center p-8 lg:p-12 relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 lg:p-16 ">
          {/* <h1 className="text-4xl lg:text-6xl font-extrabold font-montserrat text-green-700 mb-6 lg:mb-10 leading-tight">
            Thank You!
          </h1> */}
          ...
          {/* Contact Card */}
          <div className="bg-gray-50 border-l-4 border-green-700 p-6 lg:p-8 rounded-r-xl shadow-sm mb-8">
            <div className="space-y-6 lg:space-y-8">
              {/* Email */}
              <div className="flex items-center gap-4 lg:gap-6">
                <div className="w-12 h-12 lg:w-14 lg:h-14 bg-green-200 rounded-xl flex items-center justify-center text-green-700 text-xl lg:text-2xl flex-shrink-0">
                  <Mail size={24} />
                </div>
                <div>
          ...
          {/* Download CTA */}
          <div className="flex items-center gap-3 text-green-700 font-semibold text-lg group cursor-pointer">
