...
export default function BookingDetailPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: "Unit", href: `/business/units/${unitId}` },
  ...
  return (
    <div >
      {/* Booking Header */}
      <div className="flex flex-col justify-between items-start  gap-6 mb-6 bg-slate-50 p-8  shadow-sm border md:px-16 px-5 pt-5">
      ...
      <DeleteConfirmModal
        ...
        onConfirm={() => {
          setShowDelete(false);
          window.location.href = `/business/units/${unitId}`;
        }}
        item={booking}
        type="booking"
      />
